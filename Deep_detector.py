...
class Deep_detector:
    ...
    def __init__(self, prototxt, caffe_model, confidence = .5, refresh_rate = 500, glance_style = 'smooth'):
        """Creates a new detector with options to adjusts the confidence of a detected face, refresh rate of the detector, and glance style (smooth or jerky)"""
    ...
    def get_detections(self, frame):
        """returns a list of integers that represent indeces in an array of detections"""
